      ...
      {/* <div className='links-person-div'> */}
        <div className='home-page-nav-links'>
          ...
          <NavLink to='/workouts' end className='button-nav-link'>
            <span className='nav-icon'><i className="fas fa-dumbbell"></i></span><span className='nav-bar-title'>Create Workout</span>
          </NavLink>
          <NavLink to='/workouts/view' end className='button-nav-link'>
            <span className='nav-icon'><i className="fas fa-eye"></i></span><span className='nav-bar-title'>View Workouts</span>
          </NavLink>
          <NavLink to='/workouts/current' end className='button-nav-link'>
            <span className='nav-icon'><i className="fas fa-running"></i></span><span className='nav-bar-title'>Current Workout</span>
          </NavLink>
